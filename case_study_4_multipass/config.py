...
DEFAULT_QUERY = (
    ...
    "with the calibrated slip/twin parameters already set in prm.prm, and it requires the "
    "RATE-DEPENDENT constitutive model. "
    "Run the five passes in order. After the FIRST pass, compare the single-pass mechanical "
    "response against the reference simulation, reporting RMSE and MAPE. After the FIFTH pass, "
    "analyse the (0001) basal texture evolution (peak intensity vs pass number) and compare "
    "the final texture against the reference 5-pass simulation and against the experiment. "
